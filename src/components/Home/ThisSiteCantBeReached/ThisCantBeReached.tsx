...
import { motion } from 'framer-motion'; export default function ThisCantBeReached() {
            ...
            <div className="relative w-full  flex flex-col space-y-4">
                ...
                >
                    <span className="text-gray-600 font-Header text-2xl">
                        ...
                        {ShowText ? (
                            <motion.span
                                ...
                                transition={{ scale: { delay: 8, duration: 3 } }}
                                className="font-bold"
                            >
                                si pudo
                            </motion.span>
                    ...
                    <span className="text-gray-500 text-md">
                        <span className="font-bold">www.neurocarreras.netlify.app </span>
                        inesperadamente{" "}
                        {ShowText ? (
                            <motion.span
                    ...
                    <div className="flex flex-col space-y-3">
                        <span className="font-Header text-gray-400 text-lg">intenta:</span>
                        <div className="flex flex-col space-y-2 pl-10">
                            <span className="text-Header text-gray-400 font-Header sm:text-base text-sm">
                                <span className="text-bold text-gray-500">&bull;</span> chequeando tu conexion
                            </span>
                            <span className="text-Header text-blue-500 font-Header sm:text-base text-sm">
                                <span className="text-bold text-gray-500">&bull;</span> chequeando
                                tu proxy y firewall
                            </span>
                            <span className="text-Header text-blue-500 font-Header sm:text-bdase text-sm">
                                <span className="text-bold text-gray-500">&bull;</span> Ejecutando
                                Diagnóstico de red de Windows
                            </span>
                        </div>
                    </div>
